Map<String, dynamic> lv = {
  "address": {
    ...
    "streetName": ["#{Address.street_title} #{street_suffix}"],
    "streetSuffix": ["iela", "bulvāris", "gatve", "gāte", "laukums", "dambis"],
    "streetTitle": [
      "13. janvāra",
      "Admirāļu",
      "Airītes",
  ...
  "company": {
    ...
    "prefix": ["SIA", "AS", "IU", "Bezp.Org.", "Firma", "Biedrība"],
    "suffix": ["un partneri", "holdings", "grupa", "aģentūra"]
  },
  "date": {
    "month": {
      "wide": [
  ...
  "internet": {
    "domainSuffix": ["lv", "com", "info", "net", "org"],
    "freeEmail": [
      "inbox.lv",
      "one.lv",
      "mail.lv",
