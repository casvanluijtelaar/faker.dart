class Address {
  List<String> buildingNumber = ["#", "##", "###", "###a", "###b", "###c"];
  ...
  List<String> citySuffix = ["gem", "tem", "vijve", "zele"];

  List<String> defaultCountry = ["België"];
  ...
  List<String> stateAbbr = ["WVL", "OVL", "VBR", "ANT", "LIM", "BRU"];
