Map<String, dynamic> en = {
  "address": {
    ...
    "directionAbbr": ["N", "E", "S", "W", "NE", "NW", "SE", "SW"],
    "postcode": ["#####", "#####-####"],
    "postcodeByState": ["#####", "#####-####"],
  ...
  "business": {
    ...
    "creditCardTypes": ["visa", "mastercard", "americanexpress", "discover"]
  },
  "cellPhone": {
    "formats": [
      "###-###-####",
  ...
  "finance": {
    ...
    "currency": {
      ...
      "Boliviano boliviano": {"code": "BOB", "symbol": "Bs"},
      ...
      "Cuban Peso Convertible": {"code": "CUC", "symbol": "\$"},
      ...
      "Dobra": {"code": "STN", "symbol": "Db"},
      "El Salvador Colon": {"code": "SVC", "symbol": "₡"},
      ...
      "Peso Uruguayo": {"code": "UYU", "symbol": "\$U"},
      ...
      "Lesotho Loti": {"code": "LSL", "symbol": ""},
      "Namibia Dollar": {"code": "NAD", "symbol": "N\$"},
      "Zambian Kwacha": {"code": "ZMK", "symbol": ""},
      "Zimbabwe Dollar": {"code": "ZWL", "symbol": ""}
    },
    "transactionType": ["deposit", "withdrawal", "payment", "invoice"]
  },
  "hacker": {
    "abbreviation": [
      "TCP",
