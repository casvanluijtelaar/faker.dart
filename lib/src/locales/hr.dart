Map<String, dynamic> hr = {
  "address": {
    ...
    "defaultCountry": ["Hrvatska"],
    "postcode": ["#####"],
    "secondaryAddress": ["Kat #", "Stan ##"],
    "street": [
      "Adolfa Waldingera",
      "Alanska",
      "Aljmaška",
  ...
  "internet": {
    "domainSuffix": ["hr", "com", "net", "eu", "org"],
    "freeEmail": ["gmail.com", "hrnet.hr", "mailhr.hr"]
  },
  "name": {
    "femaleFirstName": [
      "Ada",
    ...
    "prefix": ["g.", "gđa.", "gđa.", "gđa", "dr."],
    "suffix": ["dipl.oecc", "dipl.ing"],
    "title": {
      "descriptor": [
        "Glavni",
        "Senior",
