Map<String, dynamic> de_AT = {
  "address": {
    ...
    "postcode": ["####"],
    "secondaryAddress": ["Apt. ###", "Zimmer ###", "# OG"],
    "state": [
      "Burgenland",
      "Kärnten",
      "Niederösterreich",
  ...
  "company": {
    "legalForm": ["GmbH", "AG", "Gruppe", "KG", "GmbH & Co. KG", "UG", "OHG"],
    "name": [
  ...
  "internet": {
    "domainSuffix": ["com", "info", "name", "net", "org", "de", "ch", "at"],
  ...
  "name": {
    ...
    "nobilityTitlePrefix": ["zu", "von", "vom", "von der"],
    "prefix": ["Dr.", "Prof. Dr."]
  },
  "phoneNumber": {
    "formats": [
