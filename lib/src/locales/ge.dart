Map<String, dynamic> ge = {
  "address": {
    ...
    "cityPrefix": ["ახალი", "ძველი", "ზემო", "ქვემო"],
    "citySuffix": ["სოფელი", "ძირი", "სკარი", "დაბა"],
    "country": [
      "ავსტრალია",
      "ავსტრია",
      "ავღანეთი",
    ...
    "defaultCountry": ["საქართველო"],
    "postcode": ["01##"],
    "secondaryAddress": ["კორპ. ##", "შენობა ###"],
    "streetAddress": ["#{street_name} #{building_number}"],
    "streetName": ["#{street_title} #{street_suffix}"],
    "streetSuffix": ["გამზ.", "გამზირი", "ქ.", "ქუჩა", "ჩიხი", "ხეივანი"],
    "streetTitle": [
      "აბაშიძის",
      "აბესაძის",
      "აბულაძის",
  ...
  "company": {
    ...
    "prefix": ["შპს", "სს", "ააიპ", "სსიპ"],
    "suffix": ["ჯგუფი", "და კომპანია", "სტუდია", "გრუპი"]
  },
  "internet": {
    "domainSuffix": ["ge", "com", "net", "org", "com.ge", "org.ge"],
    "freeEmail": ["gmail.com", "yahoo.com", "posta.ge"]
  },
  "name": {
    "firstName": [
      "აგული",
    ...
    "prefix": ["ბ-ნი", "ბატონი", "ქ-ნი", "ქალბატონი"],
    "title": {
      "descriptor": [
        "გენერალური",
        "მთავარი",
