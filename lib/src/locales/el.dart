Map<String, dynamic> el = {
  ...
  "company": {
    ...
    "suffix": ["Ε.Π.Ε.", "Α.Ε.", "και Υιοί", "Όμιλος"]
  },
  "creditCard": {
    "americanExpress": ["/34##-######-####L/", "/37##-######-####L/"],
    "discover": [
      "/6011-####-####-###L/",
      "/65##-####-####-###L/",
      "/64[4-9]#-####-####-###L/",
  ...
  "finance": {
    "accountType": ["Καταθετικός", "Μισθοδοσίας", "Δανειακός"],
    "currency": {
      "Ευρώ": {"code": "EUR", "symbol": "€"}
    },
    "transactionType": ["κατάθεση", "ανάληψη", "πληρωμή", "τιμολόγιο"]
  },
  "hacker": {
    "abbreviation": [
      "TCP",
  ...
  "internet": {
    "domainSuffix": ["gr", "com", "biz", "info", "name"],
  ...
  "name": {
    ...
    "prefix": ["Κυρία", "Δυς", "Κύριος", "Δόκτορ"],
    "title": {
      "descriptor": [
        "Senior",
        "Εταιρείες",
