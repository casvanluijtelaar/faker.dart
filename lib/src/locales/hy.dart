Map<String, dynamic> hy = {
  "address": {
    ...
    "cityPrefix": ["Հյուսիսային", "Արևելյան", "Արևմտյան", "Հարավային", "Նոր"],
    "citySuffix": ["ակերտ", "աշեն", "աշատ"],
    "country": [
      "ԱՄՆ",
      "Ադրբեջան",
      "Ալբանիա",
    ...
    "defaultCountry": ["Արցախի Հանրապետություն"],
    "direction": [
      "Հյուսիսային",
      "Արևելյան",
      "Հարավային",
    ...
    "streetAddress": ["#{address.street_name} #{address.building_number}"],
    "streetName": ["#{Name.last_name} #{street_suffix}"],
    "streetSuffix": [" փողոց", " պողոտա"]
  },
  "commerce": {
    "color": [
      "կարմիր",
  ...
  "internet": {
    "domainSuffix": ["com", "biz", "info", "name", "net", "org", "am"]
  },
  "lorem": {
    "words": [
      "տարի",
